...
- japan_inbound_visitors_monthly.csv:[https://statistics.jnto.go.jp/graph/#graph--inbound--travelers--transition](https://statistics.jnto.go.jp/graph/#graph--inbound--travelers--transition)
